...
function UserCodePythonCard({ varname, name, nationality, livingIn, birthYear, spokenLangs, progLangs, databases, wishes, optional = '' }) {

    function listToString(values) {
        let finalText = '';
        for (let item in values) {
            finalText += "'" + values[item] + "', ";
        }
    ...
    living_in='${livingIn}',
    spoken_languages=${listToString(spokenLangs)},
    programming_languages=${listToString(progLangs)},
    databases=${listToString(databases)},
    wishes_to_be='${wishes}' ${optional}
)`
    );
    return (
            ...
            <div className="code-blocks">
                <div className="code code-html">
                    ...
                    <div className="code-content">
                        <SyntaxHighlighter language='python' style={darcula} wrapLines>
                            {code}
                        </SyntaxHighlighter>
                    </div>
                </div>
...
export default UserCodePythonCard;